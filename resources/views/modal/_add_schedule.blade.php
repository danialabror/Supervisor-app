                    ...
                    <div class="w3-section">
                        ...
                        <div class="w3-row-padding">
                            <div class="w3-half">
                                ...
                                <input type="text" name="activity" class="w3-input w3-border">
                            </div>
                            <div class="w3-half">
                                <label>Kelas</label>
                                <input type="text" name="place" class="w3-input w3-border">
                            </div>
                        </div>
                        <br>
                        <div class="w3-row-padding">
                            <div class="w3-half">
                                <label>Waktu</label>
                                <input type="datetime-local" name="time" class="w3-input w3-border">
                            </div>
                            <div class="w3-half">
                                <label>Detail</label>
                                <input type="text" name="detail" class="w3-input w3-border">
                            </div>
                        </div>
                        <hr class="border-0">
